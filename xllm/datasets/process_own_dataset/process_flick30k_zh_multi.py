...
caption_txt = ['/raid/cfl/data/Flickr30k-CN/train_texts.jsonl',
               '/raid/cfl/data/Flickr30k-CN/valid_texts.jsonl']

save_path = '/raid/cfl/data/Flickr30k-CN/Flickr30k_zh_multi.json'
...
for file in caption_txt:
    ...
    if 'train' in file:
        image_ = '/raid/cfl/data/Flickr30k-CN/train_imgs.tsv'
    else:
        image_ = '/raid/cfl/data/Flickr30k-CN/valid_imgs.tsv'
    image_ = open(image_)
    image_feature = {}
